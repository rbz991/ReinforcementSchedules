...
1:              order = Int((n * Rnd() + 1))
    ...
    Private Sub Finish()
        ...
        For i = 1 To 2
            ...
            WriteLine(i, "Component 1 L1: " & ResponseCountDel(1, 0))
            WriteLine(i, "Component 2 L1: " & ResponseCountDel(2, 0))
            WriteLine(i, "Component 3 L1: " & ResponseCountDel(3, 0))
            WriteLine(i, "Component 4 L1: " & ResponseCountDel(4, 0))
            WriteLine(i, "Component 1 L2: " & ResponseCountDel(1, 1))
            WriteLine(i, "Component 2 L2: " & ResponseCountDel(2, 1))
            WriteLine(i, "Component 3 L2: " & ResponseCountDel(3, 1))
            WriteLine(i, "Component 4 L2: " & ResponseCountDel(4, 1))
            WriteLine(i, "Response rates during delay:")
            WriteLine(i, "Component 1 L1: " & ResponseCountDel(1, 0) / ((AC(1).ComponentDuration / 60)))
            WriteLine(i, "Component 2 L1: " & ResponseCountDel(2, 0) / ((AC(2).ComponentDuration / 60)))
            WriteLine(i, "Component 3 L1: " & ResponseCountDel(3, 0) / ((AC(3).ComponentDuration / 60)))
            WriteLine(i, "Component 4 L1: " & ResponseCountDel(4, 0) / ((AC(4).ComponentDuration / 60)))
            WriteLine(i, "Component 1 L2: " & ResponseCountDel(1, 1) / ((AC(1).ComponentDuration / 60)))
            WriteLine(i, "Component 2 L2: " & ResponseCountDel(2, 1) / ((AC(2).ComponentDuration / 60)))
            WriteLine(i, "Component 3 L2: " & ResponseCountDel(3, 1) / ((AC(3).ComponentDuration / 60)))
            WriteLine(i, "Component 4 L2: " & ResponseCountDel(4, 1) / ((AC(4).ComponentDuration / 60)))
